...
# set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { rows[0] }]; #IO_L6P_T0_16 Sch=pio[09]
...
# set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { cols[3] }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
...
# set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { in[19] }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
# set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVCMOS33 } [get_ports { in[20] }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
# set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { in[21] }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]
# set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { pio[22] }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]
# set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { next_state[23] }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
